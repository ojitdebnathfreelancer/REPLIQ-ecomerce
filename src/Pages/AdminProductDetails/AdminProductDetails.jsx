            ...
            <div className='bg-white p-5 rounded-md'>
                <div className='lg:flex md:flex gap-10 items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-lg capitalize font-bold my-2'>seller name: {food?.sellerName}</p>
                        <p className='text-lg capitalize font-bold my-2'>seller email: {food?.sellerEmail}</p>
