            ...
            <div className='bg-white p-5 rounded-md'>
                <div className='lg:flex md:flex gap-10 items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-lg capitalize font-bold my-2'>Buyer name: {food?.userName}</p>
                        <p className='text-lg capitalize font-bold my-2'>Buyer email: {food?.userEmail}</p>
...
export default AdminOrderDetaisl;